...
export function builder(yargs: Argv) {
  ...
  return yargs
    ...
    .alias('o', 'output')
    .describe('output', 'The output file name.')
...
async function main(argv: Arguments) {
  ...
  process.stdout.write('sending api query ... ');
  ...
  process.stdout.write(`writing output to ${JSON.stringify(argv.output)} ... `);

  await fs.writeFile(argv.output, JSON.stringify(data.hits, null, 2));
