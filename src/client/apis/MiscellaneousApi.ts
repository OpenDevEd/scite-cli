...
import {
    ...
    StatsDBFromJSON,
    StatsDBToJSON,
    SubjectCoverageDBFromJSON,
    SubjectCoverageDBToJSON,
} from '../models/index';
...
export interface GetSubjectCoverageStatsSubjectCoverageGetRequest {
    authorization?: string;
}
...
export class MiscellaneousApi extends runtime.BaseAPI {
    ...
    /**
     * Get scite general database statistics.
     * Get Scite stats object
     */
    async getStatsStatsGetRaw(requestParameters: GetStatsStatsGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<StatsDB>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => StatsDBFromJSON(jsonValue));
    }
     ...
     * Get Scite stats object
     */
    async getStatsStatsGet(requestParameters: GetStatsStatsGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<StatsDB> {
        const response = await this.getStatsStatsGetRaw(requestParameters, initOverrides);
        return await response.value();
    }

    /**
     * Get scite subject coverage database statistics.
     * Get Scite subject coverage object
     */
    async getSubjectCoverageStatsSubjectCoverageGetRaw(requestParameters: GetSubjectCoverageStatsSubjectCoverageGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<SubjectCoverageDB>>> {
        const queryParameters: any = {};
        ...
        const response = await this.request({
            path: `/stats/subject-coverage`,
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(SubjectCoverageDBFromJSON));
    }
     ...
     * Get Scite subject coverage object
     */
    async getSubjectCoverageStatsSubjectCoverageGet(requestParameters: GetSubjectCoverageStatsSubjectCoverageGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<SubjectCoverageDB>> {
        const response = await this.getSubjectCoverageStatsSubjectCoverageGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
