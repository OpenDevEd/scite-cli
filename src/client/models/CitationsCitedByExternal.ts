...
/**
 * Base model for citations cited by.
 * Used in external partner api (omits text field).
 * @export
 * @interface CitationsCitedByExternal
 */
export interface CitationsCitedByExternal {
    /**
     * 
     * @type {number}
     * @memberof CitationsCitedByExternal
     */
    id: number;
    /**
     * 
...
/**
 * Check if a given object implements the CitationsCitedByExternal interface.
 */
export function instanceOfCitationsCitedByExternal(value: object): boolean {
...
export function CitationsCitedByExternalFromJSON(json: any): CitationsCitedByExternal {
    return CitationsCitedByExternalFromJSONTyped(json, false);
}

export function CitationsCitedByExternalFromJSONTyped(json: any, ignoreDiscriminator: boolean): CitationsCitedByExternal {
    if (json == null) {
        return json;
    }
    return {
...
export function CitationsCitedByExternalToJSON(value?: CitationsCitedByExternal | null): any {
    if (value == null) {
        return value;
    }
    return {
