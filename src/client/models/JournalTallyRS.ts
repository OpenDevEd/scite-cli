 ...
 * 
 * @export
 * @interface JournalTallyRS
 */
export interface JournalTallyRS {
    /**
     * 
     * @type {number}
     * @memberof JournalTallyRS
     */
    totalCites?: number;
    /**
     * 
     ...
     * @memberof JournalTallyRS
     */
    totalSupportingCites?: number;
    /**
     * 
     * @type {number}
     * @memberof JournalTallyRS
     */
    totalMentioningCites?: number;
    /**
     * 
     * @type {number}
     * @memberof JournalTallyRS
     */
    totalContrastingCites?: number;
    /**
     * 
     * @type {number}
     * @memberof JournalTallyRS
     */
    totalUnclassifiedCites?: number;
    /**
     * 
     * @type {string}
     * @memberof JournalTallyRS
...
/**
 * Check if a given object implements the JournalTallyRS interface.
 */
export function instanceOfJournalTallyRS(value: object): boolean {
    return true;
}

export function JournalTallyRSFromJSON(json: any): JournalTallyRS {
    return JournalTallyRSFromJSONTyped(json, false);
}

export function JournalTallyRSFromJSONTyped(json: any, ignoreDiscriminator: boolean): JournalTallyRS {
    if (json == null) {
        return json;
    }
    return {
        
        'totalCites': json['totalCites'] == null ? undefined : json['totalCites'],
        'totalSupportingCites': json['totalSupportingCites'] == null ? undefined : json['totalSupportingCites'],
        'totalMentioningCites': json['totalMentioningCites'] == null ? undefined : json['totalMentioningCites'],
        'totalContrastingCites': json['totalContrastingCites'] == null ? undefined : json['totalContrastingCites'],
        'totalUnclassifiedCites': json['totalUnclassifiedCites'] == null ? undefined : json['totalUnclassifiedCites'],
        'title': json['title'] == null ? undefined : json['title'],
        'issns': json['issns'] == null ? undefined : json['issns'],
    };
}

export function JournalTallyRSToJSON(value?: JournalTallyRS | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'totalCites': value['totalCites'],
        'totalSupportingCites': value['totalSupportingCites'],
        'totalMentioningCites': value['totalMentioningCites'],
        'totalContrastingCites': value['totalContrastingCites'],
        'totalUnclassifiedCites': value['totalUnclassifiedCites'],
        'title': value['title'],
        'issns': value['issns'],
    };
}
