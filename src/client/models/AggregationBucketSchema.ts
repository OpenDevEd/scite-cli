 ...
 * 
 * @export
 * @interface AggregationBucketSchema
 */
export interface AggregationBucketSchema {
    /**
     * 
     * @type {Key}
     * @memberof AggregationBucketSchema
     */
    key: Key;
    /**
     * 
...
/**
 * Check if a given object implements the AggregationBucketSchema interface.
 */
export function instanceOfAggregationBucketSchema(value: object): boolean {
    if (!('key' in value)) return false;
    if (!('docCount' in value)) return false;
    return true;
}

export function AggregationBucketSchemaFromJSON(json: any): AggregationBucketSchema {
    return AggregationBucketSchemaFromJSONTyped(json, false);
}

export function AggregationBucketSchemaFromJSONTyped(json: any, ignoreDiscriminator: boolean): AggregationBucketSchema {
    if (json == null) {
        return json;
    }
    return {
...
export function AggregationBucketSchemaToJSON(value?: AggregationBucketSchema | null): any {
    if (value == null) {
        return value;
    }
    return {
