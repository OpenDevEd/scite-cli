...
import type { CitationsCitedByExternal } from './CitationsCitedByExternal';
import {
    CitationsCitedByExternalFromJSON,
    CitationsCitedByExternalFromJSONTyped,
    CitationsCitedByExternalToJSON,
} from './CitationsCitedByExternal';
import type { CitationsMetadataSchema } from './CitationsMetadataSchema';
import {
    CitationsMetadataSchemaFromJSON,
    CitationsMetadataSchemaFromJSONTyped,
    CitationsMetadataSchemaToJSON,
} from './CitationsMetadataSchema';
 ...
 * 
 * @export
 * @interface CitationsCitedByExternalSchema
 */
export interface CitationsCitedByExternalSchema {
    /**
     * 
     * @type {{ [key: string]: TallyDB; }}
     * @memberof CitationsCitedByExternalSchema
     */
    tallies?: { [key: string]: TallyDB; };
    /**
     * 
    ...
    /**
     * 
     * @type {CitationsMetadataSchema}
     * @memberof CitationsCitedByExternalSchema
     */
    metadata: CitationsMetadataSchema;
    /**
     * 
     * @type {Array<CitationsCitedByExternal>}
     * @memberof CitationsCitedByExternalSchema
     */
    citations: Array<CitationsCitedByExternal>;
}

/**
 * Check if a given object implements the CitationsCitedByExternalSchema interface.
 */
export function instanceOfCitationsCitedByExternalSchema(value: object): boolean {
    if (!('metadata' in value)) return false;
    if (!('citations' in value)) return false;
    return true;
}

export function CitationsCitedByExternalSchemaFromJSON(json: any): CitationsCitedByExternalSchema {
    return CitationsCitedByExternalSchemaFromJSONTyped(json, false);
}

export function CitationsCitedByExternalSchemaFromJSONTyped(json: any, ignoreDiscriminator: boolean): CitationsCitedByExternalSchema {
    if (json == null) {
        return json;
    }
    return {
        
        'tallies': json['tallies'] == null ? undefined : (mapValues(json['tallies'], TallyDBFromJSON)),
        'papers': json['papers'] == null ? undefined : (mapValues(json['papers'], PaperResponseFromJSON)),
        'metadata': CitationsMetadataSchemaFromJSON(json['metadata']),
        'citations': ((json['citations'] as Array<any>).map(CitationsCitedByExternalFromJSON)),
    };
}

export function CitationsCitedByExternalSchemaToJSON(value?: CitationsCitedByExternalSchema | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'tallies': value['tallies'] == null ? undefined : (mapValues(value['tallies'], TallyDBToJSON)),
        'papers': value['papers'] == null ? undefined : (mapValues(value['papers'], PaperResponseToJSON)),
        'metadata': CitationsMetadataSchemaToJSON(value['metadata']),
        'citations': ((value['citations'] as Array<any>).map(CitationsCitedByExternalToJSON)),
    };
}
