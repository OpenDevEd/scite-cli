...
import type { CitationExternal } from './CitationExternal';
import {
    CitationExternalFromJSON,
    CitationExternalFromJSONTyped,
    CitationExternalToJSON,
} from './CitationExternal';
 ...
 * 
 * @export
 * @interface CitationsExternalSchema
 */
export interface CitationsExternalSchema {
    /**
     * 
     * @type {{ [key: string]: TallyDB; }}
     * @memberof CitationsExternalSchema
     */
    ...
    /**
     * 
     * @type {Array<CitationExternal>}
     * @memberof CitationsExternalSchema
     */
    citations: Array<CitationExternal>;
}

/**
 * Check if a given object implements the CitationsExternalSchema interface.
 */
export function instanceOfCitationsExternalSchema(value: object): boolean {
    if (!('metadata' in value)) return false;
    if (!('citations' in value)) return false;
    return true;
}

export function CitationsExternalSchemaFromJSON(json: any): CitationsExternalSchema {
    return CitationsExternalSchemaFromJSONTyped(json, false);
}

export function CitationsExternalSchemaFromJSONTyped(json: any, ignoreDiscriminator: boolean): CitationsExternalSchema {
    if (json == null) {
        return json;
    }
    return {
        ...
        'citations': ((json['citations'] as Array<any>).map(CitationExternalFromJSON)),
    };
}

export function CitationsExternalSchemaToJSON(value?: CitationsExternalSchema | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'citations': ((value['citations'] as Array<any>).map(CitationExternalToJSON)),
    };
}
