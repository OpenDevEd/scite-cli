...
/**
 * Check if a given object implements the AuthorResults interface.
 */
export function instanceOfAuthorResults(value: object): boolean {
    return true;
}

export function AuthorResultsFromJSON(json: any): AuthorResults {
    return AuthorResultsFromJSONTyped(json, false);
}

export function AuthorResultsFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthorResults {
    if (json == null) {
        return json;
    }
    return {
...
export function AuthorResultsToJSON(value?: AuthorResults | null): any {
    if (value == null) {
        return value;
    }
    return {
