...
import type { DashboardEditorialNoticeCountSchema } from './DashboardEditorialNoticeCountSchema';
import {
    DashboardEditorialNoticeCountSchemaFromJSON,
    DashboardEditorialNoticeCountSchemaFromJSONTyped,
    DashboardEditorialNoticeCountSchemaToJSON,
} from './DashboardEditorialNoticeCountSchema';

/**
 * 
 * @export
 * @interface IssnEditorialNoticeResponse
 */
export interface IssnEditorialNoticeResponse {
    /**
     * 
     * @type {string}
     * @memberof IssnEditorialNoticeResponse
     */
    issn: string;
    /**
     * 
     * @type {DashboardEditorialNoticeCountSchema}
     * @memberof IssnEditorialNoticeResponse
     */
...
/**
 * Check if a given object implements the IssnEditorialNoticeResponse interface.
 */
export function instanceOfIssnEditorialNoticeResponse(value: object): boolean {
    if (!('issn' in value)) return false;
    return true;
}

export function IssnEditorialNoticeResponseFromJSON(json: any): IssnEditorialNoticeResponse {
    return IssnEditorialNoticeResponseFromJSONTyped(json, false);
}

export function IssnEditorialNoticeResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): IssnEditorialNoticeResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'issn': json['issn'],
        'notices': json['notices'] == null ? undefined : DashboardEditorialNoticeCountSchemaFromJSON(json['notices']),
    };
}

export function IssnEditorialNoticeResponseToJSON(value?: IssnEditorialNoticeResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'issn': value['issn'],
        'notices': DashboardEditorialNoticeCountSchemaToJSON(value['notices']),
    };
}
