...
/**
 * Check if a given object implements the TallyResponse interface.
 */
export function instanceOfTallyResponse(value: object): boolean {
...
export function TallyResponseFromJSON(json: any): TallyResponse {
    return TallyResponseFromJSONTyped(json, false);
}

export function TallyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TallyResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function TallyResponseToJSON(value?: TallyResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
