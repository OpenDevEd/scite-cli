...
/**
 * Check if a given object implements the TallyDB interface.
 */
export function instanceOfTallyDB(value: object): boolean {
...
export function TallyDBFromJSON(json: any): TallyDB {
    return TallyDBFromJSONTyped(json, false);
}

export function TallyDBFromJSONTyped(json: any, ignoreDiscriminator: boolean): TallyDB {
    if (json == null) {
        return json;
    }
    return {
...
export function TallyDBToJSON(value?: TallyDB | null): any {
    if (value == null) {
        return value;
    }
    return {
