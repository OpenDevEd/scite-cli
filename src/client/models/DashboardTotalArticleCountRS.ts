 ...
 * 
 * @export
 * @interface DashboardTotalArticleCountRS
 */
export interface DashboardTotalArticleCountRS {
    /**
     * 
     * @type {number}
     * @memberof DashboardTotalArticleCountRS
     */
    totalArticleCount?: number;
}

/**
 * Check if a given object implements the DashboardTotalArticleCountRS interface.
 */
export function instanceOfDashboardTotalArticleCountRS(value: object): boolean {
    return true;
}

export function DashboardTotalArticleCountRSFromJSON(json: any): DashboardTotalArticleCountRS {
    return DashboardTotalArticleCountRSFromJSONTyped(json, false);
}

export function DashboardTotalArticleCountRSFromJSONTyped(json: any, ignoreDiscriminator: boolean): DashboardTotalArticleCountRS {
    if (json == null) {
        return json;
    }
    return {
        
        'totalArticleCount': json['totalArticleCount'] == null ? undefined : json['totalArticleCount'],
    };
}

export function DashboardTotalArticleCountRSToJSON(value?: DashboardTotalArticleCountRS | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'totalArticleCount': value['totalArticleCount'],
    };
}
