 ...
 * 
 * @export
 * @interface ReferencesMetadataSchema
 */
export interface ReferencesMetadataSchema {
    /**
     * 
     * @type {number}
     * @memberof ReferencesMetadataSchema
     */
     ...
     * @memberof ReferencesMetadataSchema
     */
    restrictedReferenceCount?: number;
}

/**
 * Check if a given object implements the ReferencesMetadataSchema interface.
 */
export function instanceOfReferencesMetadataSchema(value: object): boolean {
    if (!('totalReferenceCount' in value)) return false;
    return true;
}

export function ReferencesMetadataSchemaFromJSON(json: any): ReferencesMetadataSchema {
    return ReferencesMetadataSchemaFromJSONTyped(json, false);
}

export function ReferencesMetadataSchemaFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReferencesMetadataSchema {
    if (json == null) {
        return json;
    }
    return {
        
        'totalReferenceCount': json['totalReferenceCount'],
        'distinctSourceCount': json['distinctSourceCount'] == null ? undefined : json['distinctSourceCount'],
        'restrictedReferenceCount': json['restrictedReferenceCount'] == null ? undefined : json['restrictedReferenceCount'],
    };
}

export function ReferencesMetadataSchemaToJSON(value?: ReferencesMetadataSchema | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'totalReferenceCount': value['totalReferenceCount'],
        'distinctSourceCount': value['distinctSourceCount'],
        'restrictedReferenceCount': value['restrictedReferenceCount'],
    };
}
