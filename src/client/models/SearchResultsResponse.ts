...
import type { AggregationSchema } from './AggregationSchema';
import {
    AggregationSchemaFromJSON,
    AggregationSchemaFromJSONTyped,
    AggregationSchemaToJSON,
} from './AggregationSchema';
import type { SearchResultSchema } from './SearchResultSchema';
import {
    SearchResultSchemaFromJSON,
    SearchResultSchemaFromJSONTyped,
    SearchResultSchemaToJSON,
} from './SearchResultSchema';
...
/**
 * Check if a given object implements the SearchResultsResponse interface.
 */
export function instanceOfSearchResultsResponse(value: object): boolean {
    if (!('count' in value)) return false;
    if (!('aggregations' in value)) return false;
    if (!('hits' in value)) return false;
    return true;
}

export function SearchResultsResponseFromJSON(json: any): SearchResultsResponse {
    return SearchResultsResponseFromJSONTyped(json, false);
}

export function SearchResultsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchResultsResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'count': json['count'],
        'aggregations': AggregationSchemaFromJSON(json['aggregations']),
        'hits': ((json['hits'] as Array<any>).map(SearchResultSchemaFromJSON)),
        'suggestedTerm': json['suggestedTerm'] == null ? undefined : json['suggestedTerm'],
        'restrictedCites': json['restrictedCites'] == null ? undefined : json['restrictedCites'],
    };
}

export function SearchResultsResponseToJSON(value?: SearchResultsResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'count': value['count'],
        'aggregations': AggregationSchemaToJSON(value['aggregations']),
        'hits': ((value['hits'] as Array<any>).map(SearchResultSchemaToJSON)),
        'suggestedTerm': value['suggestedTerm'],
        'restrictedCites': value['restrictedCites'],
    };
}
