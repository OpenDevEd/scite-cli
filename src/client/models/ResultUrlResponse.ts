 ...
 * 
 * @export
 * @interface ResultUrlResponse
 */
export interface ResultUrlResponse {
    /**
     * 
     * @type {string}
     * @memberof ResultUrlResponse
     */
    reportUrl: string;
}

/**
 * Check if a given object implements the ResultUrlResponse interface.
 */
export function instanceOfResultUrlResponse(value: object): boolean {
    if (!('reportUrl' in value)) return false;
    return true;
}

export function ResultUrlResponseFromJSON(json: any): ResultUrlResponse {
    return ResultUrlResponseFromJSONTyped(json, false);
}

export function ResultUrlResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResultUrlResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ResultUrlResponseToJSON(value?: ResultUrlResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
