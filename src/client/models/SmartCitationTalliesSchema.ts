 ...
 * 
 * @export
 * @interface SmartCitationTalliesSchema
 */
export interface SmartCitationTalliesSchema {
    /**
     * 
     * @type {{ [key: string]: TallyResponse; }}
     * @memberof SmartCitationTalliesSchema
     */
    tallies: { [key: string]: TallyResponse; };
}

/**
 * Check if a given object implements the SmartCitationTalliesSchema interface.
 */
export function instanceOfSmartCitationTalliesSchema(value: object): boolean {
    if (!('tallies' in value)) return false;
    return true;
}

export function SmartCitationTalliesSchemaFromJSON(json: any): SmartCitationTalliesSchema {
    return SmartCitationTalliesSchemaFromJSONTyped(json, false);
}

export function SmartCitationTalliesSchemaFromJSONTyped(json: any, ignoreDiscriminator: boolean): SmartCitationTalliesSchema {
    if (json == null) {
        return json;
    }
    return {
        
        'tallies': (mapValues(json['tallies'], TallyResponseFromJSON)),
    };
}

export function SmartCitationTalliesSchemaToJSON(value?: SmartCitationTalliesSchema | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'tallies': (mapValues(value['tallies'], TallyResponseToJSON)),
    };
}
