 ...
 * 
 * @export
 * @interface CitingTallySourceDB
 */
export interface CitingTallySourceDB {
    /**
     * 
     * @type {number}
     * @memberof CitingTallySourceDB
     */
    total: number;
    /**
     * 
     ...
     * @memberof CitingTallySourceDB
     */
    numCitedPublications?: number;
}

/**
 * Check if a given object implements the CitingTallySourceDB interface.
 */
export function instanceOfCitingTallySourceDB(value: object): boolean {
    if (!('total' in value)) return false;
    if (!('supporting' in value)) return false;
    if (!('contradicting' in value)) return false;
    if (!('mentioning' in value)) return false;
    if (!('unclassified' in value)) return false;
    if (!('sourceDoi' in value)) return false;
    return true;
}

export function CitingTallySourceDBFromJSON(json: any): CitingTallySourceDB {
    return CitingTallySourceDBFromJSONTyped(json, false);
}

export function CitingTallySourceDBFromJSONTyped(json: any, ignoreDiscriminator: boolean): CitingTallySourceDB {
    if (json == null) {
        return json;
    }
    return {
        ...
        'contradicting': json['contradicting'],
        'mentioning': json['mentioning'],
        'unclassified': json['unclassified'],
        'sourceDoi': json['sourceDoi'],
        'numCitedPublications': json['numCitedPublications'] == null ? undefined : json['numCitedPublications'],
    };
}

export function CitingTallySourceDBToJSON(value?: CitingTallySourceDB | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'contradicting': value['contradicting'],
        'mentioning': value['mentioning'],
        'unclassified': value['unclassified'],
        'sourceDoi': value['sourceDoi'],
        'numCitedPublications': value['numCitedPublications'],
    };
}
