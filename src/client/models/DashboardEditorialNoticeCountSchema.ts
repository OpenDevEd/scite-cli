 ...
 * 
 * @export
 * @interface DashboardEditorialNoticeCountSchema
 */
export interface DashboardEditorialNoticeCountSchema {
    /**
     * 
     * @type {number}
     * @memberof DashboardEditorialNoticeCountSchema
     */
     ...
     * @memberof DashboardEditorialNoticeCountSchema
     */
    totalExpressionOfConcerns?: number;
    /**
     * 
     * @type {number}
     * @memberof DashboardEditorialNoticeCountSchema
...
/**
 * Check if a given object implements the DashboardEditorialNoticeCountSchema interface.
 */
export function instanceOfDashboardEditorialNoticeCountSchema(value: object): boolean {
    return true;
}

export function DashboardEditorialNoticeCountSchemaFromJSON(json: any): DashboardEditorialNoticeCountSchema {
    return DashboardEditorialNoticeCountSchemaFromJSONTyped(json, false);
}

export function DashboardEditorialNoticeCountSchemaFromJSONTyped(json: any, ignoreDiscriminator: boolean): DashboardEditorialNoticeCountSchema {
    if (json == null) {
        return json;
    }
    return {
        
        'totalRetractions': json['totalRetractions'] == null ? undefined : json['totalRetractions'],
        'totalExpressionOfConcerns': json['totalExpressionOfConcerns'] == null ? undefined : json['totalExpressionOfConcerns'],
        'totalWithdrawals': json['totalWithdrawals'] == null ? undefined : json['totalWithdrawals'],
        'totalErrata': json['totalErrata'] == null ? undefined : json['totalErrata'],
        'totalCorrections': json['totalCorrections'] == null ? undefined : json['totalCorrections'],
    };
}

export function DashboardEditorialNoticeCountSchemaToJSON(value?: DashboardEditorialNoticeCountSchema | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'totalRetractions': value['totalRetractions'],
        'totalExpressionOfConcerns': value['totalExpressionOfConcerns'],
        'totalWithdrawals': value['totalWithdrawals'],
        'totalErrata': value['totalErrata'],
