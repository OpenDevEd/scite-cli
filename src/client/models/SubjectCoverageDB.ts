 ...
 * 
 * @export
 * @interface SubjectCoverageDB
 */
export interface SubjectCoverageDB {
    /**
     * 
     * @type {string}
     * @memberof SubjectCoverageDB
     */
    displayName: string;
    /**
     * 
...
/**
 * Check if a given object implements the SubjectCoverageDB interface.
 */
export function instanceOfSubjectCoverageDB(value: object): boolean {
    if (!('displayName' in value)) return false;
    if (!('publications' in value)) return false;
    if (!('citationStatements' in value)) return false;
    if (!('contrasting' in value)) return false;
...
export function SubjectCoverageDBFromJSON(json: any): SubjectCoverageDB {
    return SubjectCoverageDBFromJSONTyped(json, false);
}

export function SubjectCoverageDBFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubjectCoverageDB {
    if (json == null) {
        return json;
    }
    return {
        ...
        'citationStatements': json['citationStatements'],
        'contrasting': json['contrasting'],
...
export function SubjectCoverageDBToJSON(value?: SubjectCoverageDB | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'citationStatements': value['citationStatements'],
