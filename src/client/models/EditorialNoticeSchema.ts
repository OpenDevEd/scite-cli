 ...
 * 
 * @export
 * @interface EditorialNoticeSchema
 */
export interface EditorialNoticeSchema {
    /**
     * 
     * @type {string}
     * @memberof EditorialNoticeSchema
     */
    status?: string;
    /**
     * 
...
/**
 * Check if a given object implements the EditorialNoticeSchema interface.
 */
export function instanceOfEditorialNoticeSchema(value: object): boolean {
    if (!('doi' in value)) return false;
    return true;
}

export function EditorialNoticeSchemaFromJSON(json: any): EditorialNoticeSchema {
    return EditorialNoticeSchemaFromJSONTyped(json, false);
}

export function EditorialNoticeSchemaFromJSONTyped(json: any, ignoreDiscriminator: boolean): EditorialNoticeSchema {
    if (json == null) {
        return json;
    }
    return {
        ...
        'noticeDoi': json['noticeDoi'] == null ? undefined : json['noticeDoi'],
        'doi': json['doi'],
        'urls': json['urls'] == null ? undefined : json['urls'],
    };
}

export function EditorialNoticeSchemaToJSON(value?: EditorialNoticeSchema | null): any {
    if (value == null) {
        return value;
    }
    return {
