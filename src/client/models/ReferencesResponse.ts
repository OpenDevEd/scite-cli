...
import type { ReferenceSchema } from './ReferenceSchema';
import {
    ReferenceSchemaFromJSON,
    ReferenceSchemaFromJSONTyped,
    ReferenceSchemaToJSON,
} from './ReferenceSchema';
import type { ReferencesMetadataSchema } from './ReferencesMetadataSchema';
import {
    ReferencesMetadataSchemaFromJSON,
    ReferencesMetadataSchemaFromJSONTyped,
    ReferencesMetadataSchemaToJSON,
} from './ReferencesMetadataSchema';
...
export interface ReferencesResponse {
    /**
     * 
     * @type {ReferencesMetadataSchema}
     * @memberof ReferencesResponse
     */
    metadata: ReferencesMetadataSchema;
    /**
     * 
     * @type {Array<ReferenceSchema>}
     * @memberof ReferencesResponse
     */
...
/**
 * Check if a given object implements the ReferencesResponse interface.
 */
export function instanceOfReferencesResponse(value: object): boolean {
    if (!('metadata' in value)) return false;
    if (!('references' in value)) return false;
    return true;
}

export function ReferencesResponseFromJSON(json: any): ReferencesResponse {
    return ReferencesResponseFromJSONTyped(json, false);
}

export function ReferencesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReferencesResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'metadata': ReferencesMetadataSchemaFromJSON(json['metadata']),
        'references': ((json['references'] as Array<any>).map(ReferenceSchemaFromJSON)),
...
export function ReferencesResponseToJSON(value?: ReferencesResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'metadata': ReferencesMetadataSchemaToJSON(value['metadata']),
        'references': ((value['references'] as Array<any>).map(ReferenceSchemaToJSON)),
