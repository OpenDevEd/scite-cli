...
export interface PapersResponse {
     ...
     * @memberof PapersResponse
     */
    papers: { [key: string]: PaperResponse; };
}

/**
 * Check if a given object implements the PapersResponse interface.
 */
export function instanceOfPapersResponse(value: object): boolean {
    if (!('papers' in value)) return false;
    return true;
}

export function PapersResponseFromJSON(json: any): PapersResponse {
    return PapersResponseFromJSONTyped(json, false);
}

export function PapersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PapersResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'papers': (mapValues(json['papers'], PaperResponseFromJSON)),
    };
}

export function PapersResponseToJSON(value?: PapersResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'papers': (mapValues(value['papers'], PaperResponseToJSON)),
    };
}
