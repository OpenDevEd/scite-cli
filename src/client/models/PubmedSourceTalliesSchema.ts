 ...
 * 
 * @export
 * @interface PubmedSourceTalliesSchema
 */
export interface PubmedSourceTalliesSchema {
    /**
     * 
     * @type {{ [key: string]: { [key: string]: number; }; }}
     * @memberof PubmedSourceTalliesSchema
     */
    pubmedSourceTypeTallies: { [key: string]: { [key: string]: number; }; };
}

/**
 * Check if a given object implements the PubmedSourceTalliesSchema interface.
 */
export function instanceOfPubmedSourceTalliesSchema(value: object): boolean {
    if (!('pubmedSourceTypeTallies' in value)) return false;
    return true;
}

export function PubmedSourceTalliesSchemaFromJSON(json: any): PubmedSourceTalliesSchema {
    return PubmedSourceTalliesSchemaFromJSONTyped(json, false);
}

export function PubmedSourceTalliesSchemaFromJSONTyped(json: any, ignoreDiscriminator: boolean): PubmedSourceTalliesSchema {
    if (json == null) {
        return json;
    }
    return {
        
        'pubmedSourceTypeTallies': json['pubmedSourceTypeTallies'],
    };
}

export function PubmedSourceTalliesSchemaToJSON(value?: PubmedSourceTalliesSchema | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'pubmedSourceTypeTallies': value['pubmedSourceTypeTallies'],
    };
}
