 ...
 * 
 * @export
 * @interface PublicationLinkSchema
 */
export interface PublicationLinkSchema {
    /**
     * 
     * @type {string}
     * @memberof PublicationLinkSchema
     */
    publishedDoi: string;
}

/**
 * Check if a given object implements the PublicationLinkSchema interface.
 */
export function instanceOfPublicationLinkSchema(value: object): boolean {
    if (!('publishedDoi' in value)) return false;
    return true;
}

export function PublicationLinkSchemaFromJSON(json: any): PublicationLinkSchema {
    return PublicationLinkSchemaFromJSONTyped(json, false);
}

export function PublicationLinkSchemaFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicationLinkSchema {
    if (json == null) {
        return json;
    }
    return {
        
        'publishedDoi': json['publishedDoi'],
    };
}

export function PublicationLinkSchemaToJSON(value?: PublicationLinkSchema | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'publishedDoi': value['publishedDoi'],
    };
}
