 ...
 * 
 * @export
 * @interface SectionTallyResponse
 */
export interface SectionTallyResponse {
    /**
     * 
     * @type {number}
     * @memberof SectionTallyResponse
     */
    total: number;
    /**
     * 
...
/**
 * Check if a given object implements the SectionTallyResponse interface.
 */
export function instanceOfSectionTallyResponse(value: object): boolean {
    if (!('total' in value)) return false;
    if (!('introduction' in value)) return false;
    if (!('results' in value)) return false;
    if (!('methods' in value)) return false;
    if (!('discussion' in value)) return false;
    if (!('other' in value)) return false;
    return true;
}

export function SectionTallyResponseFromJSON(json: any): SectionTallyResponse {
    return SectionTallyResponseFromJSONTyped(json, false);
}

export function SectionTallyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SectionTallyResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function SectionTallyResponseToJSON(value?: SectionTallyResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
