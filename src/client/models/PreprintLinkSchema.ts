 ...
 * 
 * @export
 * @interface PreprintLinkSchema
 */
export interface PreprintLinkSchema {
    /**
     * 
     * @type {string}
     * @memberof PreprintLinkSchema
     */
    preprintDoi: string;
}

/**
 * Check if a given object implements the PreprintLinkSchema interface.
 */
export function instanceOfPreprintLinkSchema(value: object): boolean {
    if (!('preprintDoi' in value)) return false;
    return true;
}

export function PreprintLinkSchemaFromJSON(json: any): PreprintLinkSchema {
    return PreprintLinkSchemaFromJSONTyped(json, false);
}

export function PreprintLinkSchemaFromJSONTyped(json: any, ignoreDiscriminator: boolean): PreprintLinkSchema {
    if (json == null) {
        return json;
    }
    return {
        
        'preprintDoi': json['preprintDoi'],
    };
}

export function PreprintLinkSchemaToJSON(value?: PreprintLinkSchema | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'preprintDoi': value['preprintDoi'],
    };
}
