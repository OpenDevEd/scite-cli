...
import type { SectionTallyResponse } from './SectionTallyResponse';
import {
    SectionTallyResponseFromJSON,
    SectionTallyResponseFromJSONTyped,
    SectionTallyResponseToJSON,
} from './SectionTallyResponse';

/**
 * 
 * @export
 * @interface SectionTalliesSchema
 */
export interface SectionTalliesSchema {
    /**
     * 
     * @type {{ [key: string]: SectionTallyResponse; }}
     * @memberof SectionTalliesSchema
     */
    tallies: { [key: string]: SectionTallyResponse; };
}

/**
 * Check if a given object implements the SectionTalliesSchema interface.
 */
export function instanceOfSectionTalliesSchema(value: object): boolean {
    if (!('tallies' in value)) return false;
    return true;
}

export function SectionTalliesSchemaFromJSON(json: any): SectionTalliesSchema {
    return SectionTalliesSchemaFromJSONTyped(json, false);
}

export function SectionTalliesSchemaFromJSONTyped(json: any, ignoreDiscriminator: boolean): SectionTalliesSchema {
    if (json == null) {
        return json;
    }
    return {
        
        'tallies': (mapValues(json['tallies'], SectionTallyResponseFromJSON)),
    };
}

export function SectionTalliesSchemaToJSON(value?: SectionTalliesSchema | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'tallies': (mapValues(value['tallies'], SectionTallyResponseToJSON)),
    };
}
