 ...
 * 
 * @export
 * @interface AggregateTallyResponse
 */
export interface AggregateTallyResponse {
    /**
     * 
     * @type {number}
     * @memberof AggregateTallyResponse
     */
    total: number;
    /**
     * 
...
/**
 * Check if a given object implements the AggregateTallyResponse interface.
 */
export function instanceOfAggregateTallyResponse(value: object): boolean {
...
export function AggregateTallyResponseFromJSON(json: any): AggregateTallyResponse {
    return AggregateTallyResponseFromJSONTyped(json, false);
}

export function AggregateTallyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AggregateTallyResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'citingPublications': json['citingPublications'] == null ? undefined : json['citingPublications'],
    };
}

export function AggregateTallyResponseToJSON(value?: AggregateTallyResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'doi': value['doi'],
        'citingPublications': value['citingPublications'],
    };
}
