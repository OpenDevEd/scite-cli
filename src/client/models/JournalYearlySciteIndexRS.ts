 ...
 * 
 * @export
 * @interface JournalYearlySciteIndexRS
 */
export interface JournalYearlySciteIndexRS {
    /**
     * 
     * @type {string}
     * @memberof JournalYearlySciteIndexRS
     */
    relativeYear?: string;
    /**
     * 
...
/**
 * Check if a given object implements the JournalYearlySciteIndexRS interface.
 */
export function instanceOfJournalYearlySciteIndexRS(value: object): boolean {
    return true;
}

export function JournalYearlySciteIndexRSFromJSON(json: any): JournalYearlySciteIndexRS {
    return JournalYearlySciteIndexRSFromJSONTyped(json, false);
}

export function JournalYearlySciteIndexRSFromJSONTyped(json: any, ignoreDiscriminator: boolean): JournalYearlySciteIndexRS {
    if (json == null) {
        return json;
    }
    return {
        ...
        'siTwoYears': json['siTwoYears'] == null ? undefined : json['siTwoYears'],
        'siFiveYears': json['siFiveYears'] == null ? undefined : json['siFiveYears'],
        'siAllYears': json['siAllYears'] == null ? undefined : json['siAllYears'],
        'issns': json['issns'] == null ? undefined : json['issns'],
    };
}

export function JournalYearlySciteIndexRSToJSON(value?: JournalYearlySciteIndexRS | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'siTwoYears': value['siTwoYears'],
        'siFiveYears': value['siFiveYears'],
        'siAllYears': value['siAllYears'],
        'issns': value['issns'],
    };
}
