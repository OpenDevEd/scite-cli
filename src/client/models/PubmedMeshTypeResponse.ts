 ...
 * 
 * @export
 * @interface PubmedMeshTypeResponse
 */
export interface PubmedMeshTypeResponse {
    /**
     * 
     * @type {string}
     * @memberof PubmedMeshTypeResponse
     */
    descriptorId: string;
    /**
     * 
...
/**
 * Check if a given object implements the PubmedMeshTypeResponse interface.
 */
export function instanceOfPubmedMeshTypeResponse(value: object): boolean {
    if (!('descriptorId' in value)) return false;
    if (!('descriptorName' in value)) return false;
    return true;
}

export function PubmedMeshTypeResponseFromJSON(json: any): PubmedMeshTypeResponse {
    return PubmedMeshTypeResponseFromJSONTyped(json, false);
}

export function PubmedMeshTypeResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PubmedMeshTypeResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'descriptorId': json['descriptorId'],
        'descriptorName': json['descriptorName'],
        'qualifierId': json['qualifierId'] == null ? undefined : json['qualifierId'],
        'qualifierName': json['qualifierName'] == null ? undefined : json['qualifierName'],
    };
}

export function PubmedMeshTypeResponseToJSON(value?: PubmedMeshTypeResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'qualifierName': value['qualifierName'],
    };
}
