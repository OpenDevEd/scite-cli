...
/**
 * Check if a given object implements the DateBucket interface.
 */
export function instanceOfDateBucket(value: object): boolean {
    if (!('docCount' in value)) return false;
...
export function DateBucketFromJSON(json: any): DateBucket {
    return DateBucketFromJSONTyped(json, false);
}

export function DateBucketFromJSONTyped(json: any, ignoreDiscriminator: boolean): DateBucket {
    if (json == null) {
        return json;
    }
    return {
...
export function DateBucketToJSON(value?: DateBucket | null): any {
    if (value == null) {
        return value;
    }
    return {
