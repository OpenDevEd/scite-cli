 ...
 * 
 * @export
 * @interface CitationsMetadataSchema
 */
export interface CitationsMetadataSchema {
    /**
     * 
     * @type {number}
     * @memberof CitationsMetadataSchema
     */
     ...
     * @memberof CitationsMetadataSchema
     */
    restrictedCitationCount?: number;
}

/**
 * Check if a given object implements the CitationsMetadataSchema interface.
 */
export function instanceOfCitationsMetadataSchema(value: object): boolean {
    if (!('totalCitationCount' in value)) return false;
    return true;
}

export function CitationsMetadataSchemaFromJSON(json: any): CitationsMetadataSchema {
    return CitationsMetadataSchemaFromJSONTyped(json, false);
}

export function CitationsMetadataSchemaFromJSONTyped(json: any, ignoreDiscriminator: boolean): CitationsMetadataSchema {
    if (json == null) {
        return json;
    }
    return {
        
        'totalCitationCount': json['totalCitationCount'],
        'restrictedCitationCount': json['restrictedCitationCount'] == null ? undefined : json['restrictedCitationCount'],
    };
}

export function CitationsMetadataSchemaToJSON(value?: CitationsMetadataSchema | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'totalCitationCount': value['totalCitationCount'],
        'restrictedCitationCount': value['restrictedCitationCount'],
    };
}
